...
export function RunForm({ spot, courses, initial, returnTo }: { spot: { id: string; slug: string; name: string }; courses: { id: string; name: string; distanceM: number }[]; initial?: Values; returnTo?: "spot" | "me" }) {
