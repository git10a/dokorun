...
type Links = { instagram?: string | null; xHandle?: string | null; strava?: string | null; stravaClub?: string | null };
...
export function SocialLinks({ links }: { links: Links }) {
  const items = [
    ...
    links.stravaClub && { label: "Strava", href: socialUrl("stravaClub", links.stravaClub), path: icons.strava },
